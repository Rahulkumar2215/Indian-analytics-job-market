...
![Skill demand vs salary premium](figures/chart_skill_premium.png)
...
![Median salary by city and seniority](figures/chart_city_seniority.png)
...
**6. Dashboard.** A Power BI report is built on the exported dataset. It includes KPI cards, a Decomposition Tree, synced slicers, bookmarks and Row-Level Security.
